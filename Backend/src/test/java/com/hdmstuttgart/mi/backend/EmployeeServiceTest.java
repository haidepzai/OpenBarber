...
public class EmployeeServiceTest {
    ...
    /**
     ...
     employeeService. It creates a new Employee object with the name "john" and assigns it to an Shop object. The
     createEmployee() method is then called, passing the Employee and Shop IDs as arguments. The test then retrieves
    ...
    public void testCreateEmployee() throws MalformedURLException {
        ...
        employeeService.createEmployee(employee, shop.getId());
