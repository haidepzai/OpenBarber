    ...
    >
      ...
      >
        <Stack direction="row" alignItems="center" gap={2} mb={4}>
          ...
          <Typography variant="h6" fontFamily="Roboto" fontWeight="500">OpenBarber</Typography>
        ...
        {isSent ? (
          <Stack alignItems="center" spacing={3} py={4}>
            ...
            <Typography variant="h6" textAlign="center">{t('FORGOT_PASSWORD_SENT')}</Typography>
          </Stack>
        ) : (
          <form onSubmit={handleSubmit}>
            <Stack spacing={3}>
              <Typography variant="h5" fontWeight="500">{t('FORGOT_PASSWORD_TITLE')}</Typography>
              <Typography variant="body1" color="text.secondary">{t('FORGOT_PASSWORD_DESC')}</Typography>
              <TextField
