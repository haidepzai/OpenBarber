                ...
                <FormGroup sx={{ padding: "6px 0 0 3px"}}>
                    {Object.keys(filter.paymentMethods).map((method) => (
                        <FormControlLabel
                            key={method}
                            control={
                                <Checkbox checked={filter.paymentMethods[method]} onChange={() => updateFilter("paymentMethods", method)} name={method}  />
                            }
                            label={method
                                .replace("onSiteCash", "On Site (Cash)")
                                .replace("onSiteCard", "On Site (Card)")
                                .replace("_", " ")
                            }
                ...
                <FormGroup sx={{ padding: "6px 0 0 3px"}}>
                    {Object.keys(filter.drinks).map((drink) => (
                        <FormControlLabel
                            key={drink}
                            control={
                                <Checkbox checked={filter.drinks[drink]} onChange={() => updateFilter("drinks", drink)} name={drink}  />
                            }
