...
function EnhancedTableHead(props: EnhancedTableProps) {
  ...
  const createSortHandler = (property: keyof Service) => (event: React.MouseEvent<unknown>) => {
...
export default function ServiceTable(props: ServiceTableProps) {
  ...
  const handleRequestSort = (event: React.MouseEvent<unknown>, property: keyof Service) => {
