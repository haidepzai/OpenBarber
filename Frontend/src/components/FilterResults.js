        ...
        <Box sx={{ flex: "4 1 0" }}>
            <Stack direction="row" justifyContent="space-between" alignItems="center" sx={{ width: "100%", m: "20px 0" }}>
                <Typography variant="body1">
                    {shops.length} Barber Shops available near you / in Stuttgart
                </Typography>
                <FormControl>
                    ...
                    <Stack direction="row" sx={{ mb: "20px"}} spacing={2}>
                        ...
                        <Stack direction="column" spacing={1}>
                            ...
                            <Typography variant="body1" sx={{ fontSize: "18px", fontWeight: "bold", letterSpacing: "3px" }}>
                                <Typography variant="span" sx={{ color: (shop.priceCategory === 1 || shop.priceCategory === 2 || shop.priceCategory === 3) ? "black" : "rgba(0, 0, 0, 0.2)" }}>&#8364;</Typography>
                                <Typography variant="span" sx={{ color: (shop.priceCategory === 2 || shop.priceCategory === 3) ? "black" : "rgba(0, 0, 0, 0.2)" }}>&#8364;</Typography>
                                <Typography variant="span" sx={{ color: (shop.priceCategory === 3) ? "black" : "rgba(0, 0, 0, 0.2)" }}>&#8364;</Typography>
                            </Typography>
