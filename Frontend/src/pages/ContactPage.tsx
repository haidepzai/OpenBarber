              ...
              <form onSubmit={onSubmit} noValidate>
                <Stack spacing={3}>
                  <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2}>
                    <TextField name="name" label={t('CONTACT_NAME')} required fullWidth error={!!fieldErrors.name} helperText={fieldErrors.name} />
                    <TextField
                      name="email"
                  ...
                  <TextField name="subject" label={t('CONTACT_SUBJECT')} select fullWidth defaultValue="general">
                  ...
                  {state.errors && Object.keys(state.errors).length > 0 && <Alert severity="error">{t('CONTACT_ERROR')}</Alert>}
                  ...
                  <Button
                    ...
                    color="primary"
                    size="large"
                    endIcon={state.submitting ? <CircularProgress size={18} color="inherit" /> : <SendIcon />}
