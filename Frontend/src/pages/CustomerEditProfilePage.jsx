...
import {
  Box, Typography, TextField, Button, Stack, Avatar, CircularProgress, Alert,
  ...
  return (
    <Box sx={{ width: '500px', margin: '40px auto', minHeight: '60vh' }}>
      ...
      <FormControl fullWidth sx={{ mb: fieldErrors.salutation ? 1 : 3 }} error={!!fieldErrors.salutation}>
        ...
        {fieldErrors.salutation && <Typography variant="caption" color="error" sx={{ ml: 1.75, mt: 0.5 }}>{t('CANT_BE_EMPTY', 'Pflichtfeld')}</Typography>}
      </FormControl>
      ...
      {success && <Alert severity="success" sx={{ mb: 2 }}>{t('SAVED', 'Gespeichert!')}</Alert>}
